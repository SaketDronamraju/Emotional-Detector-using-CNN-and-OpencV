...
In this case the code was excetued on spyder 
after we run the code we can exit the program by clicking on q on the keyboard
...
#by pressing q we can terminate the program  
